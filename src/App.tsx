        ...
        <main className={styles.grid}>
          <section className={`${styles.card} ${styles.about}`}>
            ...
            <div className={styles.sectionTitle}>
              Builds clean, high-performing products.
            </div>
            <p className={styles.subtle}>
              Full-stack engineer with a UI-first mindset. I bridge product,
              data, and engineering to ship fast, reliable experiences.
            </p>
          ...
          <section className={`${styles.card} ${styles.footerTile}`}>
            ...
            <div className={styles.terminalLog}>
              ...
              <div className={styles.footer}>
                © {new Date().getFullYear()} Nicolas Ricaldi.
              </div>
            </div>
          </section>
        </main>
